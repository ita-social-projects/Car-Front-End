...
export const MEDIUM_JOURNEY_PAGE_POPUP_HEIGHT = 100 + getStatusBarHeight();
export const MAX_JOURNEY_PAGE_POPUP_HEIGHT = 490 + getStatusBarHeight();
...
export const MAX_USER_FULL_NAME_LENGTH_IN_PROFILE = 28;
...
export const JOURNEY_CARD_WITH_FEE_HEIGHT = 134;