...
const JourneyStartPage = (props: NavigationAddListener) => {
    ...
    useEffect(() => {
        ...
        setRequestedButtonTextStyle( selectedIndex == FIFTH_ELEMENT_INDEX ? activeButtonTextStyle : inactiveButtonTextStyle);
        setCanceledButtonTextStyle( selectedIndex == FIFTH_ELEMENT_INDEX ? activeButtonTextStyle : inactiveButtonTextStyle);
