...
const ApplicantProfile = (user: any) => {
    const [avatar] = useState(
        <ActivityIndicator
            style={JourneyApplicantStyle.headerUserAvatar}
            size="large"
            color="black"
        />
    );
        ...
        <>
            <View style={JourneyApplicantStyle.headerContainer}>
                ...
                <View style={JourneyApplicantStyle.headerUserInformation}>
                    ...
                    <Text
                        style={JourneyApplicantStyle.headerUserAdditionalData}
                    >
            ...
            <View style={JourneyApplicantStyle.footerContainer}>
                <Text style={{ height: 50, width: 300 }}>Details</Text>
                <Text style={{ height: 50, width: 300 }}>Position:</Text>
                <Text style={{ height: 380, width: 300 }}>Location:</Text>
            </View>
        </>
    );
};
