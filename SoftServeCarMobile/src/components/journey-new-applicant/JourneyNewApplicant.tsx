...
export const JourneyNewApplicant = () => {
  ...
  return (
    <View>
      ...
      >
        <Text style={JourneyNewApplicantStyle.acceptButtonText}>Show</Text>
      </TouchableOpacity>
          ...
          <View style={JourneyNewApplicantStyle.container}>
            <View style={JourneyNewApplicantStyle.row}>
              ...
              <View style={item(50)}>
                ...
                >
                  <Text style={JourneyNewApplicantStyle.snooze}>Snooze</Text>
                </TouchableOpacity>
              </View>
            </View>
            <View
            ...
            >
              <View style={item(20)}>
                <View style={JourneyNewApplicantStyle.circle}>
                  <Text style={JourneyNewApplicantStyle.icon}>JB</Text>
                </View>
              </View>
              <View style={item(70)}>
              ...
              <View style={item(10)}>
                <View>
                  <TouchableOpacity>
                    <Text style={JourneyNewApplicantStyle.more}>...</Text>
                  </TouchableOpacity>
                </View>
              </View>
            </View>
              ...
              >
                <View style={[item(5), JourneyNewApplicantStyle.tripColumn]}>
                  <Circle
                    ...
                    marginTop={"0.5rem"}
                  >
                    <Circle color="#C1C1C5" radius="0.35rem" />
                  </Circle>
                  <View style={JourneyNewApplicantStyle.stopLine} />
                </View>
                <View style={[item(95), JourneyNewApplicantStyle.tripPoint]}>
